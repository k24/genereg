 ...
 */
public class BooleanRegistry extends Registry<Boolean> {
    public BooleanRegistry(@Nonnull PrimitiveStore store, @Nonnull String name, Boolean defaultValue) {
        super(store, name, defaultValue);
    }

    protected Primitive toPrimitive(Boolean value) {
